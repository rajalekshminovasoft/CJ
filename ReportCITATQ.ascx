<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReportCITATQ.ascx.cs" Inherits="ReportCITATQ" %>
                        ...
                        <tr>
                            <td id="Td7" runat="server" colspan="4" style="padding-top: 5px">
                                <asp:LinkButton ID="lbtnBack0" runat="server" Font-Bold="True" 
                                    Font-Names="Arial" Font-Size="12px" Font-Underline="False" ForeColor="Blue" OnClick="lbtnBack_Click"
                                     Visible="False">&lt;&lt; Back</asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3">
                                <div align="left">
                                    <asp:LinkButton ID="lbtnBack" runat="server" Font-Bold="True" Font-Size="12px" 
                                        ...
                                        Visible="False" Font-Names="Arial" OnClick="lbtnBack_Click">&lt;&lt; Back
                                    </asp:LinkButton>
                                </div>
                            </td>
                            <td>
